...
public class PrincipalGato extends JFrame {
	...
	private static PrincipalGato frame = new PrincipalGato();
	...
	public void initComponents() {
		...
		ImageIcon ii = new ImageIcon(this.getClass().getResource("../resources/jugar.png"));
		...
		ImageIcon ir = new ImageIcon(this.getClass().getResource("../resources/reiniciar.png"));
		...
		ImageIcon is = new ImageIcon(this.getClass().getResource("../resources/logout.png"));
	...
	public void btn1() {
		ImageIcon imgBoton=null;
	       if(jugador && jugada[0][0].equals("-")){
	           imgBoton = new ImageIcon(this.getClass().getResource("../resources/X.png"));
	           colocarJugada(0,0,"X");
	           jugador = false;
	           if(maquina()) {
	        	   jugador = true;
	           ...
	           imgBoton = new ImageIcon(this.getClass().getResource("../resources/O.png"));
	           colocarJugada(0,0,"O");
	           jugador = true;
	           if(persona()) {
	        	   jugador = false;
